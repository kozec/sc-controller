#!/usr/bin/env python2
"""
UInput emulation on Windows.

Please, note that this works in completly different way and does not implement
anything even remotelly resembling uinput kernel module.

Emulation is incomplete and provides only functions needed for SC-Controller.
"""
