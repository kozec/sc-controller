/**
 * This is almost-verbatim copy of hid.c used only when
 * building SC-Controller for Windows.
 *
 * Only change is in open_device() function, where share_mode
 * is zeroed to give scc-daemon exclusive access to gamepads.
 */
