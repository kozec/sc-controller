...
#### `Controller: controller_id nameable controller name`
...
- `nameable` is True if controller can be renamed by user.
- `controller name` is free-form string generated by driver or assigned by 
  user and should be used in UI.
