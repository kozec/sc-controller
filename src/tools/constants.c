...
SCButton scc_string_to_button(const char* s) {
	...
	case 'B':
		...
		break;
	case 'D':
		if (0 == strcmp("DOTS", s)) return B_DOTS;
		break;
	default:
...
PadStickTrigger scc_string_to_pst(const char* s) {
	...
	case 'R':
		...
		if (0 == strcmp("RSTICK", s)) return PST_RSTICK;
		break;
	case 'L':
	...
	case 'S':
		...
		break;
	case 'D':
		if (0 == strcmp("DPAD", s)) return PST_DPAD;
		break;
	case 'G':
...
const char* scc_what_to_string(PadStickTrigger what) {
	...
	case PST_DPAD:		return "DPAD";
	case PST_STICK:		return "STICK";
	case PST_RSTICK:	return "RSTICK";
...
const char* scc_button_to_string(SCButton b) {
	// TODO: okay, why the f is this stuff not autogenerated?
	switch (b) {
	...
	case B_RGRIP2:		return "RGRIP2";
	case B_LGRIP:		return "LGRIP";
	case B_LGRIP2:		return "LGRIP2";
	...
	case B_RSTICKPRESS:	return "RSTICKPRESS";
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wswitch"
	case SCC_DEFAULT:	return "DEFAULT";
